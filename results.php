...
$dvd = $_GET['dvd_title']; //$_REQUEST['dvd_title'] - takes any request type
$sql = " SELECT title, genre_name, format_name, rating_name
    ...
    WHERE title LIKE ?
    ";
// WHERE title = $dvd would be unsanitized
...
echo "<div class='span12'><h3><em>You searched for '" . $dvd . ".'</em></h3></div>";
